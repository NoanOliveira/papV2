        ...
        <!-- Navbar End -->
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded-top p-4">
                    <h3 class="text-center">papel para visita de estudo</h3>
                    <p class="text-center">Adicione aqui o conteúdo desejado.</p>
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelect"
                                    ...
                                    <option selected>pegar na db!</option>
                                    <option value="1">One</option>
                                    <option value="2">Two</option>
                                    <option value="3">Three</option>
                                </select>
                                <label for="floatingSelect">Curso Profissional Técnico de:</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="Exemplo 2023-2026">
                                <label for="floatingInput">Curso de Formção:</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="Exemplo 2023-2026">
                                <label for="floatingInput">Ciclo de Formção:</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="Exemplo 2023-2026">
                                <label for="floatingInput">Ano Curricular:</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="Exemplo 2023-2026">
                                <label for="floatingInput">Nº de Formandos:</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="Exemplo 2023-2026">
                                <label for="floatingInput">Nº de Formandos (acompanhantes):</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="Exemplo 2023-2026">
